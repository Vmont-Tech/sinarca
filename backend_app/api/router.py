...
from backend_app.modules.blockchain.routes import router as blockchain_router
from backend_app.modules.certifier.routes import router as certifier_router
from backend_app.modules.integrity.routes import router as integrity_router
