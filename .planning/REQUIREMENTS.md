...
- [x] **INTG-03**: `Conflict` é gerado automaticamente quando `ST_Intersects` (Phase 4.1) encontra overlap acima do limiar configurável, com severidade `CLEAR → CRITICAL`. *(schema pronto na Plan 04.2-01; geração de Conflict é a Plan 04.2-03)*
