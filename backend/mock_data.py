...
PROJECTS: list[dict[str, Any]] = [
    {
        ...
        "status": "RETIRED",
        "metrics": {"totalAreaHa": 12450, "carbonStock": 145200, "investmentValue": 6534000, "vintage": "2023"},
    ...
    },
    {
        ...
        "status": "AVAILABLE",
        "metrics": {"totalAreaHa": 5800, "carbonStock": 85000, "investmentValue": 4250000, "vintage": "2024"},
        "description": "Recuperação de áreas degradadas no bioma Cerrado com foco em agricultura regenerativa.",
        "baseline": "Área degradada por pastagem intensiva por mais de 10 anos.",
        ...
        "timeline": [{"title": "Aprovação Final", "date": "25 Fev 2024", "status": "completed", "desc": "Projeto migrado para status AVAILABLE."}],
    },
    {
        "type": "PROJECT",
        ...
        "status": "AVAILABLE",
        "metrics": {"totalAreaHa": 15000, "carbonStock": 500000, "investmentValue": 27500000, "vintage": "2024"},
...
AUDITORS = [
    ...
    {"id": "aud-005", "name": "Vinícius Monteiro", "role": "Auditor", "verified": True, "projects_audited": 15, "rating": 5.0},
]
...
USERS = [
    ...
    {"id": "prod-001", "name": "Produtor Demo", "email": "produtor@sinarca.com.br", "document": "123.456.789-00", "role": "producer", "password": "produtor"},
    {"id": "comp-001", "name": "Banco Futuro", "email": "empresa@sinarca.com.br", "document": "999.888.777-66", "role": "company", "password": "empresa"},
    {"id": "cert-001", "name": "Certificadora Verra", "email": "certificadora@sinarca.com.br", "document": "555.444.333-22", "role": "certifier", "password": "certificadora"},
]
