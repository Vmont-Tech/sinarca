...
export default function Settings() {
    ...
    const [company, setCompany] = useState('Banco Futuro');
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
                        ...
                        <div className="mt-12 flex justify-end">
                            <button className="px-8 py-4 bg-black text-white font-bold text-xs uppercase tracking-widest rounded-2xl flex items-center gap-3 hover:bg-primary transition-all shadow-xl">
