            ...
            <aside className={`sticky top-0 h-screen w-72 flex flex-col border-r border-gray-200 ${sidebarBg} hidden lg:flex z-50 transition-colors duration-500`}>
                <div className="flex flex-col h-full p-8">
                    ...
                    <nav className="flex flex-col gap-2 flex-1">
                        ...
                        {isCompany && (
                            <>
                                <SidebarItem to="/painel/marketplace" icon={Store} label="Comprar Créditos" active={location.pathname === '/painel/marketplace' || location.pathname === '/painel/comprar-creditos'} theme={sidebarTheme} />
